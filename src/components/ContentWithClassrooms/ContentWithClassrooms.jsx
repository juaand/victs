                ...
                <div className="col-12 col-sm-8">
                    {!bool ?
                        <div className="row p-0">
                            {data.length  > 0 ? data.slice(0, 4).map(el =>
                            ...
                            ) : <h2>It seems no classrooms has added <strong>keep calm and <Link className="inner-link" to="classrooms">build some!</Link></strong></h2>}
                        </div>
                        :
                        <div className="row p-0">
                            {data.map(el =>
